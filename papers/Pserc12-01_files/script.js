...
var gDocTable = new Array(
   ...
   new hrefList("slide0020.htm", 1, 2),
   new hrefList("slide0035.htm", 1, 3),
   new hrefList("slide0021.htm", 1, 4),
   new hrefList("slide0022.htm", 1, 5),
   new hrefList("slide0023.htm", 1, 6),
   new hrefList("slide0024.htm", 1, 7),
   new hrefList("slide0025.htm", 1, 8),
   new hrefList("slide0026.htm", 1, 9),
   new hrefList("slide0027.htm", 1, 10),
   new hrefList("slide0028.htm", 1, 11),
   new hrefList("slide0029.htm", 1, 12),
   new hrefList("slide0036.htm", 1, 13),
   new hrefList("slide0037.htm", 1, 14)
);
