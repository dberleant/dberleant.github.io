...
var gDocTable = new Array(
   ...
   new hrefList("slide0011.htm", 1, 3),
   new hrefList("slide0016.htm", 1, 4),
   new hrefList("slide0017.htm", 1, 5),
   new hrefList("slide0018.htm", 1, 6),
   new hrefList("slide0002.htm", 1, 7),
   new hrefList("slide0003.htm", 1, 8),
   new hrefList("slide0005.htm", 1, 9),
   new hrefList("slide0006.htm", 1, 10),
   new hrefList("slide0010.htm", 1, 11),
   new hrefList("slide0019.htm", 1, 12),
   new hrefList("slide0007.htm", 1, 13),
   new hrefList("slide0012.htm", 1, 14),
   new hrefList("slide0008.htm", 1, 15),
   new hrefList("slide0013.htm", 1, 16),
   new hrefList("slide0014.htm", 1, 17),
   new hrefList("slide0015.htm", 1, 18),
   new hrefList("slide0009.htm", 1, 19),
