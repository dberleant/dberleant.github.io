...
var ENDSHOW_MESG="End of slide show, click to exit.", SCREEN_MODE="Frames", gIsEndShow=0, NUM_VIS_SLDS=22, SCRIPT_HREF="script.js", FULLSCR_HREF="fullscreen.htm";
...
var gDocTable = new Array(
   ...
   new hrefList("slide0006.htm", 1, 5),
   ...
   new hrefList("slide0014.htm", 1, 13),
   new hrefList("slide0023.htm", 1, 14),
